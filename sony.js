        ...
        */
        ...
        if(products.length > 0){
            ...
            products.forEach((arrTmp) => {
                ...
                if (productMap.has(key) && arrTmp['product_url'].includes('https://shopatsc.com/')) {
            ...
            if(ArrGetProductInfo.length > 0){
                ...
                for (const product of ArrGetProductInfo) {
                    ...
                    //const productUrl = "https://shopatsc.com/collections/all/products/ht-s500rf";
                    ...
                    if (hostname.includes('shopatsc')) {
                        try {
                            ...
                            if(await page.$('div.product-template__container') === null) {
                                ...
                                const result = await page.evaluate(() => {
                                    ...
                                    return {
                                        ...
                                        availability: productData.offers?.[0]?.availability || '',

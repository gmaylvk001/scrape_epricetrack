    ...
    try {
        ...
        */
        ...
        products.forEach((arrTmp) => {
            ...
            if (
                productMap.has(key) &&
                arrTmp['product_url'].includes('https://nikshanonline.com')
            ) {
            ...
            try {
                ...
                */
                ...
                const productPageExists =
                    await page.$('.single-product-page');

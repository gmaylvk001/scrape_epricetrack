        ...
        */
        ...
        if(products.length > 0){
            ...
            products.forEach((arrTmp) => {
                ...
                if (productMap.has(key) && arrTmp['product_url'].includes('https://nikshanonline.com')) {
                ...
                for (const product of ArrGetProductInfo) {
                    ...
                    if (hostname.includes('nikshan')) {
                        try {
                            ...
                            if(await page.$('.single-product-page') === null) {

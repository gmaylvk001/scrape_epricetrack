    ...
    try {
        ...
        */
        ...
        const products = await executeMongoFind(
            {
                collection: 'ept_product_details_new_myg',
                cmpid
            },
            filter,
            { _id: 0 }
        ...
        if(products.length > 0){
            ...
            products.forEach((arrTmp) => {
                ...
                if (productMap.has(key) && arrTmp['product_url'].includes('https://www.myg.in/')) {
                ...
                for (const product of ArrGetProductInfo) {
                    ...
                    if (hostname.includes('myg')) {
                        ...
                        try {
                            ...
                            if(await page.$('.mosuk-product-page') === null) {
                                ...
                                const result = await page.evaluate(() => {
                                    ...
                                    return {
                                        ...
                                        review: product.aggregateRating?.reviewCount || 0,
